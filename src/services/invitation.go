...
func (service *InvitationService) UpdateInvitationStatus(invitatioID int, status string) error {
	return service.InvitRepo.UpdateInvitationStatus(invitatioID, status)
}
